class ZsrOmnibarMilestoneTracker extends Polymer.Element {
	static get is() {
		return 'zsr-omnibar-milestone-tracker';
	}
	...
	enter(displayDuration) {
		...
		console.log(this.milestone.precedingMilestone.total);
...
customElements.define(ZsrOmnibarMilestoneTracker.is, ZsrOmnibarMilestoneTracker);
