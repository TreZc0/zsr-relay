(function () {
	 ...
	 * @polymer
	 */
	class ZsrOmnibarChallenge extends Polymer.Element {
		static get is() {
			return 'zsr-omnibar-challenge';
		}
		...
		render() {
			...
			this.$.progressFill.svgDoc.size(
				...
				this.$.progressBlock.svgDoc.height() * 2
			);
	...
	customElements.define(ZsrOmnibarChallenge.is, ZsrOmnibarChallenge);
})();
