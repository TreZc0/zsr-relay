(function () {
	...
	class ZsrOmnibarMilestoneAlert extends Polymer.Element {
		static get is() {
			return 'zsr-omnibar-milestone-alert';
		}
		...
		_calcLayer3Message(succeedingMilestone) {
			...
			return '<b>NEW ZSRM DONATION MILESTONE!</b>';
		}
	}

	customElements.define(ZsrOmnibarMilestoneAlert.is, ZsrOmnibarMilestoneAlert);
})();
