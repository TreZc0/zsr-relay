(function () {
	 ...
	 * @polymer
	 */
	class ZsrOmnibarList extends Polymer.Element {
		static get is() {
			return 'zsr-omnibar-list';
		}
		...
		_marginSizeChanged(newVal) {
			this.updateStyles({
				'--zsr-omnibar-list-margin-size': `${newVal}px`
			});
		}
	}

	customElements.define(ZsrOmnibarList.is, ZsrOmnibarList);
})();
