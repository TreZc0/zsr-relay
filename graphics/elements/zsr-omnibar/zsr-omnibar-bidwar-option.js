(function () {
	 ...
	 * @polymer
	 */
	class ZsrOmnibarBidwarOption extends Polymer.Element {
		static get is() {
			return 'zsr-omnibar-bidwar-option';
		}
	...
	customElements.define(ZsrOmnibarBidwarOption.is, ZsrOmnibarBidwarOption);
})();
