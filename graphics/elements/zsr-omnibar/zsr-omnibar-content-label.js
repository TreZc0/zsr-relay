(function () {
	 ...
	 * @polymer
	 */
	class ZsrOmnibarContentLabel extends Polymer.Element {
		static get is() {
			return 'zsr-omnibar-content-label';
		}
	...
	customElements.define(ZsrOmnibarContentLabel.is, ZsrOmnibarContentLabel);
})();
