...
(function () {
	...
	/**
	 * The options argument for the `show` and `change` methods in zsr-omnibar-label.
	 * @typedef {Object} LabelShowAndChangeOptions
	 * @property {String} avatarIconName - The name of the icon to use for the avatar. Must be present in zsr-omnibar-icons.
	...
	class ZsrOmnibarLabel extends Polymer.Element {
		static get is() {
			return 'zsr-omnibar-label';
		}
		...
		show(text, {avatarIconName, flagHoldDuration, ringColor, flagColor}) {
			...
			showTL.set(this, {
				'--zsr-omnibar-label-ring-color': ringColor,
				'--zsr-omnibar-label-flag-color': flagColor
			});
		...
		change(text, {avatarIconName, flagHoldDuration, ringColor, flagColor}) {
			 ...
			 * later pause, edit, and resume the timeline in zsr-omnibar.
			 */
	...
	customElements.define(ZsrOmnibarLabel.is, ZsrOmnibarLabel);
})();
